...
public class Encounter {
    ...
    public enum Boss {
        Wrathion,Maut,ProphetSkitra,InquisitorXanesh,Hivemind,Shadhar,Drestagarth,Ilgynoth,Vexiona,Ra-den,Carapace,N'zoth,Sivara,Behemoth,Radiance,Ashvana,Orgozoa,QueensCourt,Zaqul,Azshara, Champion, Grong, JadefireMasters, Opulence, Conclave, Rastakhan, Mekkatorque, Blockade, Jaina, RestlessCabal, Uunat, UNKNOWN
    }
}
